...
class FlowerGantt {
	...
	onCreated() {
		this.innerHTML = `
			...
			<div class="gantt-ver-scroll" style="display: block; height: 311px; width: 18px; top: 30px;">
				<div style="height: 408px;"></div>
			</div>
			<div class="gantt-hor-scroll" style="display: block; width: 1512px; height: 18px;">
