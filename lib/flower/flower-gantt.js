		...
		this.innerHTML = `
			<div class="gantt-tree" style="height: 339px; width: 379px;">
				<div class="gantt-tree-scale" style="height: 29px; line-height: 28px; width: 379px;">
					<div class="gantt-tree-scale-cell" style="width:196px;" column_id="text">炮塔</div>
				</div>
				<div class="gantt-tree-data" style="height: 309px; width: 379px;" data-layer="true">
					<div class="gantt-tree-row" style="height: 27px; line-height: 27px;" task_id="1">
						<div class="gantt-tree-cell" style="width:196px;">
					...
					<div class="gantt-tree-row odd" style="height: 27px; line-height: 27px;" task_id="1379082074907">
						<div class="gantt-tree-cell" style="width:196px;">
					...
					<div class="gantt-tree-row" style="height: 27px; line-height: 27px;" task_id="1379082074911">
						<div class="gantt-tree-cell" style="width:196px;">
							<div class="gantt-tree-indent"></div>
							<div class="gantt-tree-icon gantt-blank"></div>
							<div class="gantt-tree-icon gantt-file"></div>
					...
					<div class="gantt-tree-row odd" style="height: 27px; line-height: 27px;" task_id="1379082074912">
						<div class="gantt-tree-cell" style="width:196px;">
							<div class="gantt-tree-indent"></div>
							<div class="gantt-tree-icon gantt-blank"></div>
							<div class="gantt-tree-icon gantt-file"></div>
					...
					<div class="gantt-tree-row" style="height: 27px; line-height: 27px;" task_id="1379082074913">
						<div class="gantt-tree-cell" style="width:196px;">
							<div class="gantt-tree-indent"></div>
							<div class="gantt-tree-icon gantt-blank"></div>
							<div class="gantt-tree-icon gantt-file"></div>
					...
					<div class="gantt-tree-row odd" style="height: 27px; line-height: 27px;" task_id="1379082074914">
						<div class="gantt-tree-cell" style="width:196px;">
							<div class="gantt-tree-indent"></div>
							<div class="gantt-tree-icon gantt-blank"></div>
							<div class="gantt-tree-icon gantt-file"></div>
					...
					<div class="gantt-tree-row" style="height: 27px; line-height: 27px;" task_id="1379082074915">
						<div class="gantt-tree-cell" style="width:196px;">
							<div class="gantt-tree-indent"></div>
							<div class="gantt-tree-icon gantt-blank"></div>
							<div class="gantt-tree-icon gantt-file"></div>
					...
					<div class="gantt-tree-row odd" style="height: 27px; line-height: 27px;" task_id="1379339521965">
						<div class="gantt-tree-cell" style="width:196px;">
							<div class="gantt-tree-icon gantt-close"></div>
							<div class="gantt-tree-icon gantt-folder-open"></div>
					...
					<div class="gantt-tree-row" style="height: 27px; line-height: 27px;" task_id="1379339521969">
						<div class="gantt-tree-cell" style="width:196px;">
							<div class="gantt-tree-indent"></div>
							<div class="gantt-tree-icon gantt-blank"></div>
							<div class="gantt-tree-icon gantt-file"></div>
					...
					<div class="gantt-tree-row odd" style="height: 27px; line-height: 27px;" task_id="1379339521970">
						<div class="gantt-tree-cell" style="width:196px;">
							<div class="gantt-tree-indent"></div>
							<div class="gantt-tree-icon gantt-blank"></div>
							<div class="gantt-tree-icon gantt-file"></div>
					...
					<div class="gantt-tree-row" style="height: 27px; line-height: 27px;" task_id="1379339521971">
						<div class="gantt-tree-cell" style="width:196px;">
							<div class="gantt-tree-indent"></div>
							<div class="gantt-tree-icon gantt-blank"></div>
							<div class="gantt-tree-icon gantt-file"></div>
					...
					<div class="gantt-tree-row odd" style="height: 27px; line-height: 27px;" task_id="1379339521972">
						<div class="gantt-tree-cell" style="width:196px;">
							<div class="gantt-tree-indent"></div>
							<div class="gantt-tree-icon gantt-blank"></div>
							<div class="gantt-tree-icon gantt-file"></div>
					...
					<div class="gantt-tree-row" style="height: 27px; line-height: 27px;" task_id="1379339521973">
						<div class="gantt-tree-cell" style="width:196px;">
							<div class="gantt-tree-indent"></div>
							<div class="gantt-tree-icon gantt-blank"></div>
							<div class="gantt-tree-icon gantt-file"></div>
					...
					<div class="gantt-tree-row odd" style="height: 27px; line-height: 27px;" task_id="1379339521974">
						<div class="gantt-tree-cell" style="width:196px;">
							<div class="gantt-tree-indent"></div>
							<div class="gantt-tree-icon gantt-blank"></div>
							<div class="gantt-tree-icon gantt-file"></div>
