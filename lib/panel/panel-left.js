...
class LeftPanel {
	/**
	 * DOM callback invoked when a new LeftPanel is created.
	 */
	createdCallback() {
		/**
		 * @type {Panel}
	...
	/**
	 * Attaches the LeftPanel to a Left Panel.
	 */
	attach() {
		if (!this.panel) {
	...
	/**
	 * DOM callback invoked when a new LeftPanel is attached to the DOM.
	 */
	attachedCallback() {
	...
	/**
	 * Detaches the LeftPanel from the DOM.
	 */
	detach() {
		if (this.panel) {
			this.panel.destroy();
	...
	/**
	 * DOM callback invoked when a new LeftPanel is detached from the DOM.
	 */
	detachedCallback() {
		console.info('LeftPanel detachedCallback');
	}

	/**
	 * Destroys this LeftPanel
	 */
	destroy() {
...
module.exports = registerOrUpdateElement('atom-panel-flower-left', {class: LeftPanel});
